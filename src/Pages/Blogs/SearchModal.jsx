      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-4 inset-x-4 md:inset-x-auto md:left-1/2 md:right-auto md:-translate-x-1/2 md:w-full md:max-w-2xl bg-gradient-to-r from-[#141122] to-secondary-500 shadow-2xl overflow-hidden z-50"
          >
            {/* Search Header */}
            ...
            <div className="max-h-[calc(100vh-200px)] overflow-y-auto">
              {searchStatus === "loading" ? (
                ...
                <div className="p-2">
                  {filteredPosts.map((post) => (
                    <motion.div
                      ...
                      className="border-b border-b-primary-950/30"
                    >
                ...
                <div className="flex flex-col items-center justify-center p-8 text-center">
                  ...
                  <p className="mt-1 text-primary-200">Start typing to search</p>
                </div>
              )}
            </div>
          </motion.div>
