  ...
  return (
    <div className="container mx-auto">
      <div className="my-10 text-center">
        ...
        <h4 className="text-lg md:text-xl xl:text-2xl italic tracking-wide text-gray-400">
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 xl:gap-8 py-6">
        ...
        <div className="w-full lg:w-[55%] xl:w-[65%]">
          ...
          <Table className="table-auto">
            ...
            <TableBody>
              {appointment?.appointment_packages?.map((item) => (
                <TableRow key={item.id}>
                  <TableCell className="md:w-[300px] lg:w-[450px]">
            ...
            <TableFooter>
              <TableRow>
                <TableCell className="font-semibold uppercase text-right">Total</TableCell>
