...
const Index = () => {
  return (
    <div className="relative min-h-screen py-16">
      <div
        className="relative mx-auto bg-no-repeat bg-center bg-contain h-[70vh] flex flex-col md:flex-row items-center justify-center"
        style={{ backgroundImage: `url(${mainAstro})` }}
      >
        <div className="flex flex-col md:flex-row justify-center items-center gap-8">
          {/* First Card */}
          <div className="relative mr-28 xl:mr-60">
          ...
          {/* Center Content */}
          <div className="md:max-w-md xl:max-w-lg px-6 text-center">
            <div>
          ...
          <div className="relative ml-28 xl:ml-60">
