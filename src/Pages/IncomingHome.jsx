    ...
    <div className="pt-16">
      ...
      <div className="container mx-auto px-4 pt-20 pb-32 relative">
        ...
        >
          ...
          >
            <div className="w-32 h-32 mx-auto bg-gradient-to-br from-purple-500/20 to-indigo-500/20 rounded-full flex items-center justify-center backdrop-blur-sm border border-purple-500/30 relative">
              <motion.div
                animate={{
                  rotate: 360,
                }}
          ...
          <motion.h1
            ...
            className="text-6xl md:text-8xl font-serif text-transparent bg-clip-text bg-gradient-to-r from-purple-200 to-indigo-200 mb-6"
          >
            TarotByCharm
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-purple-200/80 mb-16 max-w-2xl mx-auto"
          >
        ...
        >
          {[
            ...
            >
              <div
                className={`h-full bg-gradient-to-br ${item.gradient} backdrop-blur-md border border-purple-500/30 rounded-2xl p-8 transition-all duration-300`}
              >
                <motion.div
                  initial={{ rotate: 0 }}
                  animate={{ rotate: 360 }}
                ...
                <div className="relative">
                  <div className="w-16 h-16 mb-6 bg-purple-900/50 rounded-xl flex items-center justify-center group-hover:bg-purple-800/50 transition-colors">
                  ...
                  <p className="text-purple-200/80 group-hover:text-purple-100 transition-colors">
                    {item.description}
                  </p>
                </div>
              </div>
              <div className="absolute -inset-0.5 bg-gradient-to-r from-purple-500/30 to-indigo-500/30 rounded-2xl blur opacity-0 group-hover:opacity-100 transition-opacity" />
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-purple-500/5 to-indigo-500/5 rounded-3xl backdrop-blur-sm -z-10" />
          <Feather className="w-12 h-12 mx-auto mb-6 text-purple-300" />
          <h2 className="text-4xl font-serif text-white mb-8">
            About TarotByCharm
          </h2>
          <p className="text-lg text-purple-200/90 mb-6 px-6">
            With over a decade of experience in spiritual guidance and tarot
            reading, TarotByCharm offers profound insights into your life
            journey. Our readings combine ancient wisdom with modern
            understanding to provide you with clarity and direction.
          </p>
          <p className="text-lg text-purple-200/90 px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <motion.div
                key={pkg.title}
                whileHover={{ y: -10 }}
                className={`relative p-8 rounded-2xl backdrop-blur-md border border-purple-500/30 
                  ${
                    pkg.featured
              ...
              >
                <div className="absolute inset-0.5 bg-gradient-to-r from-purple-500/10 to-indigo-500/10 rounded-2xl blur-xl -z-10" />
                ...
                <button className="w-full py-3 px-6 rounded-xl bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-semibold hover:from-purple-600 hover:to-indigo-600 transition-colors">
                  Choose {pkg.title}
                </button>
              </motion.div>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <motion.div
                key={post.title}
                whileHover={{ y: -10 }}
                className="group relative rounded-2xl overflow-hidden backdrop-blur-md border border-purple-500/30"
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-serif text-white mb-3 group-hover:text-purple-300 transition-colors">
                    {post.title}
                  </h3>
                  <p className="text-purple-200/80 mb-4">{post.excerpt}</p>
                  <button className="text-purple-300 hover:text-white transition-colors flex items-center">
                    Read more
