...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${styles.paddingX} ${styles.flexCenter} w-full py-4 border-b border-gray-500 z-50  bg-gradient-to-r from-[#141122] to-secondary-500 fixed top-0`}
    >
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        ...
        <div
          className={`${
            toggle ? "flex" : "hidden"
          } p-6 bg-gradient-to-r from-[#141122] to-secondary-500 absolute top-20 right-0 mx-4 my-2 min-w-[140px] rounded-xl sidebar`}
        >
